...
const addCart = AsyncWrapper(async (req, res) => {
        ...
        if (eachCartItem.productId === productId) {
            if (quantity) {
                eachCartItem = {
                    productId: productId,
                    quantity: quantity,
                    colorOption: eachCartItem.colorOption,
                    sizeOption: eachCartItem.sizeOption
                }
            } else {
...
const deleteFromCart = AsyncWrapper(async (req, res) => {
